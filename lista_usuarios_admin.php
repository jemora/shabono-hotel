...
$query_Recordset2 = "SELECT * FROM usuarios WHERE adm_3 LIKE '1' ORDER BY ID ASC";
...
<table width="612" border="0" align="left" cellspacing="2" bordercolor="#CCCCCC">
  <tr>
    <td width="122" height="16" bgcolor="#000000" ><div align="left" class="Estilo7 Estilo8">Usuario</div></td>
    <td height="16" colspan="3" bgcolor="#000000" ><span class="Estilo9">Nombre</span></td>
  </tr>
  <?php do { ?>
  <tr>
    <td width="122" height="22" bgcolor="#C8D5E4" ><span class="Estilo6"><?php echo $row_Recordset2['usuario']; ?></span></td>
    <td bgcolor="#C8D5E4" ><span class="Estilo6"><?php echo $row_Recordset2['nombre']; ?></span></td>
    <td width="138" c"><div align="center" class="Estilo6">
