...
<div align="center"><img src="imagenes/banne2.gif" width="607" height="30" /></div>
<table width="619" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="220" height="28" bgcolor="#FFFFFF"><form action="opcion1.php" method="POST">
  
      <div align="left">
        <table width="508" border="0" cellspacing="0">
        <tr>
          <th width="178" scope="col"><span class="small">Busqueda de Clientes </span></th>
          <th width="47" scope="col"><img src="imagenes/ico_2.gif" width="18" height="18" /></th>
          ...
          <th width="87" scope="col"><span class="small">Clientes</span><span class="Estilo8"> <a href="javascript:Abrir_ventana('buscador_cliente.php')"><img src="imagenes/view.gif" width="17" height="17" border="0" /></a></span></th>
        </tr>
      </table>
      </div>
    </form>
