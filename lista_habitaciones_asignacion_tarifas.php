...
$query_Recordset2 = "SELECT * FROM serv_asig  ORDER BY id";
...
$sSQL="Delete From serv_asig   Where id like '$codigo'";
mysql_query($sSQL);
      ...
      <tr valign="middle" > </tr>
        ...
        <table width="600" border="0" align="center" cellspacing="2" bordercolor="#CCCCCC">
          <tr>
            ...
            <td height="16" bgcolor="#000000" ><div align="left" class="Estilo2" >Tipo</div></td>
            <td height="16" bgcolor="#000000" ><span class="Estilo2">Precio</span></td>
            <td height="16" bgcolor="#000000" >&nbsp;</td>
          </tr>
          <?php do { ?>
          <tr>
            <td width="50" height="26" bgcolor="#CCD8E6" ><span ><?php echo $row_Recordset2['id_serv']; ?></span></td>
            <td width="89" bgcolor="#CCD8E6" ><div align="left"><span ><?php echo $row_Recordset2['habitacion']; ?></span></div></td>
            <td width="164" bgcolor="#CCD8E6" ><div align="left" ><?php echo $row_Recordset2['tipo2']; ?></div></td>
