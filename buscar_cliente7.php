...
<table width="601" border="0" align="center">
  <tr>
    <th scope="col"><form action="opcion8.php" method="post">
  
      <div align="left">
        <table width="586" border="0" cellspacing="0">
        <tr>
          <th width="164" scope="col"><span class="small"> Facturas de Clientes </span></th>
          <th width="125" scope="col"><input name="codigo" type="text" id="codigo" size="22" maxlength="150" / style="background-color:e3e3e3; border: 1px solid #666666; font-size:8pt; color: #000099" /></th>
          <th width="54" scope="col"><input name="submit" type="submit" value="Buscar" /></th>
          <th width="138" scope="col"><span class="small">Clientes</span><span class="Estilo7"> <a href="javascript:Abrir_ventana('buscador_cliente.php')"><img src="imagenes/view.gif" width="17" height="17" border="0" /></a></span></th>
          <th width="95" scope="col"><span class="small">Planning <a href="javascript:Abrir_ventana('buscar_calendario.php')"><img src="imagenes/show-calendar.gif" width="18" height="16" border="0" /></a></span></th>
        </tr>
      </table>
        </div>
    </form></th>
  ...
  <tr>
    <th scope="col"><div align="left">
      <?php include("opcion_facturas.php");?>
    </div></th>
  </tr>
</table>
<br />
