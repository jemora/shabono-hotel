...
$query_Recordset2 = "SELECT * FROM caja WHERE fecha1 like '$codigo' ORDER BY id DESC";
...
<table width="81%" border="0" align="center" cellpadding="0" cellspacing="2">
  ...
  <tr>
    <td height="18" valign="top" bgcolor="#FFFFFF" class="small"><span class="Estilo2">Lista de Cajas cerradas por dia :</span>
      <map name="Map">
