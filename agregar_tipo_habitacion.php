...
$id_habitacion=$test1[0]+1;





$usuarios_consulta = mysql_query("SELECT id_tipo FROM hab_tipo where tipo like '$tipo'") or die(mysql_error());
...
mysql_query("INSERT INTO hab_tipo (id_habitacion,tipo,precio) VALUES ('$id_habitacion','$tipo','$precio')");
...
<table width="280" height="116" align="center" cellpadding="2" cellspacing="2" class="estilotabla">
  <tr>
    <td class="estilocelda">Agregar Tipo de Habitaci&ograve;n    </td>
  </tr>
  <tr>
    <td height="86"><form action="?id3=agregar" method="post">
            <div align="left">
              <table width="471" border="0" cellspacing="0">
                <tr>
                  <th width="156" class="Estilo7" scope="col"><div align="left">Tipo de Habitacion</div></th>
                ...
                <tr>
                  <th class="Estilo7" scope="col"><div align="left">Precio de este tipo de Habitacion</div></th>
...
$sSQL="Delete From hab_tipo Where id_tipo like '$codigo'";
mysql_query($sSQL);
...
?>
  <br />
  <?php require('lista_tipo_habitaciones.php'); ?>
</p>
