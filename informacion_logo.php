...
<table width=601 height=140 align="center" cellpadding=2 cellspacing=2 class="estilotabla">
  <tr>
    <td width="165" height="16" class="estilocelda">Actualizar Logo Sistema Hotelero </td>
  </tr>
  <tr>
    ...
    <form ENCTYPE="multipart/form-data" action="informacion01.php?id5=logo" method="POST">
	<p>
