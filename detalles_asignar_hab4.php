  ...
  <tr>
    <td width="560" height="24" valign="top"><table width="601" border="0" align="center" cellspacing="0">
      ...
      <tr>
        ...
        <td width="238" bgcolor="#F4F4F4"><a href="habitacion_asiganar_multi.php?&codigo=<?php echo $codigo ?>&multi=<?php echo $multi; ?>"><img src="imagenes/mas_asignar.gif" width="235" height="28" border="0" longdesc="imagenes/mas_reservas.gif"></a><a href="habitacion_reservacion_multi.php?&codigo=<?php echo $codigo ?>&multi=<?php echo $multi; ?>"></a></td>
      </tr>
    </table></td>
  </tr>
</table>
