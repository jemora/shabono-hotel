...
<table width="619" border="0" align="center" cellpadding="0" cellspacing="0">
  <!--DWLayoutTable-->
  <tr>
    <td width="619" height="28" valign="top"><table width="603" height="15" border="0" align="left" cellspacing="0" bgcolor="#FF9900">
  <tr>
    <td width="595" height="28" bgcolor="#FFFFFF"><form action="opcion6.php" method="post">
  
      <div align="left">
        <table width="592" border="0" cellspacing="0">
        <tr>
          <th width="228" scope="col"><span class="Estilo8">Buscar Habitaciones Asignadas</span></th>
          <th width="131" scope="col"><input name="codigo" type="text" id="codigo" size="22" maxlength="150" / style="background-color:e3e3e3; border: 1px solid #666666; font-size:8pt; color: #000099" /></th>
          <th width="54" scope="col"><input name="submit" type="submit" value="Buscar" /></th>
          <th width="68" scope="col"><span class="small">Busqueda de Clientes </span></th>
          <th width="101" scope="col"><span class="small">Clientes </span><span class="Estilo7"><a href="javascript:Abrir_ventana('buscador_cliente.php')"><img src="imagenes/view.gif" width="17" height="17" border="0" /></a></span></th>
        </tr>
      </table>
        </div>
    </form>
