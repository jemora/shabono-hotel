      ...
      <table width="584" border="0" align="center" cellspacing="0" bordercolor="#000066">
        <tr>
          <th width="582" scope="col"><table width="582" border="0" cellspacing="0" cellpadding="4" align="center">
            <tr bgcolor="#FFFFCC">
              <td bgcolor="#EEF3F7" class="small"><div align="right" class="Estilo1">
                <div align="left"><font size="2">Empresa
                  : </font></div>
              </div></td>
              <td colspan="3" bgcolor="#EEF3F7" class="small"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">
...
?>" type="text">
            ...
            <tr>
              <td width="147" bgcolor="#EEF3F7" class="small"><div align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">rif
                : </font></div></td>
              <td colspan="3" bgcolor="#EEF3F7" class="small"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">
...
?>" type="text">
            ...
            <tr bgcolor="#FFFFCC">
              <td width="147" bgcolor="#EEF3F7" class="small"><div align="left"><font face="Verdana" size="2"><font face="Verdana" size="2"><font face="Verdana, Arial, Helvetica, sans-serif">Pais:</font> </font></font></div></td>
              <td width="145" bgcolor="#EEF3F7" class="small"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">
...
?>" type="text">
              ...
              <td width="97" bgcolor="#EEF3F7" class="small"><div align="left"><font face="Verdana" size="2"><font face="Verdana" size="2"><font face="Verdana, Arial, Helvetica, sans-serif">Ciudad:</font> </font></font></div></td>
              <td width="161" bgcolor="#EEF3F7" class="small"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">
...
?>" type="text">
            ...
            <tr bgcolor="#FFFFCC">
              <td width="147" bgcolor="#EEF3F7" class="small"><div align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><font size="2">Direccion:</font> </font></div></td>
              <td colspan="3" bgcolor="#EEF3F7" class="small"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">
...
?>
            ...
            <tr bgcolor="#FFFFCC">
              <td height="13" bgcolor="#EEF3F7" class="small"><div align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Telefono :</font></div></td>
              <td height="13" colspan="3" bgcolor="#EEF3F7" class="small"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">
...
?>" type="text">
            ...
            <tr bgcolor="#FFFFCC">
              <td height="7" bgcolor="#EEF3F7" class="small"><div align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Correo Electronico:</font></div></td>
              <td height="7" colspan="3" bgcolor="#EEF3F7" class="small"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">
...
?>" type="text">
            ...
            <tr bgcolor="#FFFFCC">
              <td height="40" bgcolor="#EEF3F7" class="small">&nbsp;</td>
              <td height="40" colspan="3" bgcolor="#EEF3F7" class="small">&nbsp;</td>
            </tr>
            <tr bgcolor="#FFFFCC">
              <td height="40" colspan="4" bgcolor="#EEF3F7"><div align="center"><font face="Verdana" size="2"><font face="Verdana" size="2"><font face="Verdana" size="2"><span class="Estilo3">
                <input name="fecha" type="hidden" id="fecha" value="<?php echo date("d-m-Y"); ?>" size="25" />
                          ...
                          <input type="submit" name="Submit" value="   Actualizar Empresa   " class="botones" />
              </div></td>
            </tr>
          </table></th>
        </tr>
