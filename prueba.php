...
////////////////////////////////sentencia para enviar el correo masivo
require_once('conector/conector.php');
$mysql = mysql_connect($hostname,$username,$password);
mysql_select_db($database);
$resp = mysql_query("SELECT * FROM habitacion_reservas_web ");
$nums = mysql_num_rows($resp);
while($u=mysql_fetch_array($resp)) {
$inc++;
if($inc == $nums) { $semail .= $u['email']; }
else { $semail .= $u['email'].", "; }
}
...
$msg = "mensaje";
$titulo="titulo";
$contenido="contrenido";
# Enviamos el email.
mail($_CONF['email'],$titulo,$msg,$headers);
    ...
    <td bgcolor="#FFFFFF"><table width="770" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="601" valign="top" bgcolor="#FFFFFF"><table border="0" cellpadding="0" cellspacing="0" width="688">
            ...
            <tr>
              <td height="293" background="images/web01_r2_c1.jpg">&nbsp;</td>
              <td valign="top"><iframe width="665" id="iframecont" onload="resize(false);" src="visualizador.php" scrolling="Auto" frameborder="0" height="850" marginheight="0" marginwidth="0" name="frame"></iframe></td>
              <td background="images/web01_r2_c3.jpg">&nbsp;</td>
