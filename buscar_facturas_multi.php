...
<table width="601" border="0" align="center">
  <tr>
    <th scope="col"><form action="opcion8.php" method="post">
      ...
      <div align="left">
        ...
        <tr>
          <th width="165" scope="col"><span class="small"> Facturas de Clientes </span></th>
          ...
          <th width="70" scope="col"><input name="submit" type="submit" value="Buscar" /></th>
          <th width="156" scope="col"><span class="small">Clientes</span><span class="Estilo7"> <a href="javascript:Abrir_ventana('buscador_cliente.php')"><img src="imagenes/view.gif" width="17" height="17" border="0" /></a></span></th>
  ...
  <tr>
    <th scope="col"><table width="601" border="1" align="center" cellspacing="0" bordercolor="#999999" bgcolor="#F4F4F4">
      <!--DWLayoutTable-->
      <tr>
  ...
  <tr>
    <th scope="col"><?php include("lista_facturas_x_cancelar_multi.php");?></th>
  </tr>
</table>
