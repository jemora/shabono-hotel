...
<body>
<table width="615" border="1" align="center" cellspacing="0" bordercolor="#CCCCCC">
  <tr>
    <td height="16" bgcolor="#CCCCCC" ><div align="left" class="Estilo1">Fecha</div></td>
    <td height="16" bgcolor="#CCCCCC" ><div align="left"><span class="Estilo1"> Habitacion  </span></div></td>
  ...
  <?php do { ?>
  <tr>
    <td width="90" height="34" ><div align="right"><span class="Estilo1"><strong>Desde:</strong><?php echo $row_Recordset2['fecha1']; ?><br />
      <strong>Hasta:</strong><?php echo $row_Recordset2['fecha2']; ?></span></div></td>
    <td width="118" ><div align="left"><span class="Estilo1"><?php echo $row_Recordset2['habitacion']; ?></span><span class="Estilo1"><?php echo $row_Recordset2['nom_hab']; ?></span></div></td>
    ...
    <td width="41" c"><div align="center"><a href="detalles_habitacion2.php?&codigo=<?php echo $row_Recordset2['id']; ?>" class="Estilo1"> Detalles</a></div></td>
