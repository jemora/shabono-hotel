...
$codigo = $_GET["codigo"];
$query_Recordset2 = "SELECT * FROM clientes WHERE ID  LIKE '$codigo'";
...
<table width="391" border="0" align="center" cellspacing="0">
  <tr>
    <th width="389" scope="col"><div align="left"><strong>
  ...
  <tr>
    <td><strong>Actualizar Cliente: </strong></td>
  </tr>
  <tr>
    <td height="20"><table width="81%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="100%" valign="top"><div align="right" >
            ...
            <form name=frm onSubmit="return Verificar()" method="POST" action="actualizar_clientes_datos.php?codigo2=<?php echo $row_Recordset2['doc2']; ?>&id=datos&id2=actualizar" enctype="multipart/form-data">
              <table width="597" border="1" align="center" cellspacing="0" bordercolor="#000033">
                <tr>
				  ...
				  ?>
                      ...
                      <tr>
                        <td height="40" colspan="2"><div align="center"><font face="Verdana" size="2"><font face="Verdana" size="2"><font face="Verdana" size="2"><span class="Estilo3"> </span><font face="Verdana" size="2"><font face="Verdana" size="2"><span class="Estilo3"> </span><font face="Verdana" size="2"><font face="Verdana" size="2"><font face="Verdana" size="2"><font face="Verdana" size="2"><span class="Estilo3"> </span><font face="Verdana" size="2"><font face="Verdana" size="2"><span class="Estilo3">
