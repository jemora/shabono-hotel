...
$query_Recordset2 = "SELECT * FROM habitacion2 WHERE status LIKE 'reservada' and doc2 like '$codigo' ORDER BY id ASC";
...
<table width="605" border="0" align="center" cellspacing="2" bordercolor="#CCCCCC">
  ...
  <?php do { ?>
  <tr>
    <td height="28" bgcolor="#E3E9F1" ><div align="left" class="Estilo14 Estilo19"><?php echo $row_Recordset2['doc2']; ?> <?php echo $row_Recordset2['nombre']; ?> <?php echo $row_Recordset2['apellido']; ?></div>
