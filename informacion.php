...
$result7 = mysql_query("SELECT * FROM informacion WHERE id  LIKE '1'");
      ...
      <td width="100%" height="305" valign="top"><div align="right" >
        ...
        <tr>
          <th width="591" scope="col"><table width="567" border="0" cellspacing="0" cellpadding="4" align="center">
            <tr >
              <td width="151"><div align="left" class="small">Titulo de Pagina: </font></div></td>
              <td ><div align="left"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">
                <input name="nombre" type="text" class="small" id="nombre" /style="background-color:e3e3e3; border: 1px solid #666666; font-size:8pt; color: #000099" value="<?
...
?>" size="50" >
            ...
            <tr>
              <td width="151"><div align="left" class="small">Telefono:</font></div></td>
              <td><div align="left"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">
                <input name="telefono" type="text" class="small" id="telefono" value="<?
...
?>" /style="background-color:e3e3e3; border: 1px solid #666666; font-size:8pt; color: #000099" >
            ...
            <tr>
              <td width="151"><div align="left" class="small">Correo:</font></div></td>
              <td><div align="left"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">
                <input name="correo" type="text" class="small" id="correo" /style="background-color:e3e3e3; border: 1px solid #666666; font-size:8pt; color: #000099" value="<?
...
?>" size="50" >
            ...
            <tr >
              <td width="151"><div align="left" class="small">Rif:</font></div></td>
              <td><div align="left"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">
              <input name="rif" type="text" class="small" id="rif" value="<?
...
?>" /style="background-color:e3e3e3; border: 1px solid #666666; font-size:8pt; color: #000099" >
            ...
            <tr >
              <td height="13"><div align="left" class="small">Informacion:</font></div></td>
...
?>" size="50" style="background-color:e3e3e3; border: 1px solid #666666; font-size:8pt; color: #000099" >
            ...
            <tr >
              <td height="3"><div align="left" class="small">Direcci&oacute;n</font></div></td>
              <td height="3" ><div align="left"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">
...
?>
            ...
            <tr >
              <td height="4" class="small">url ubicacion del portal </td>
              <td height="4" ><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">
                <input name="url" type="text" class="imputbox" id="url" style="background-color:e3e3e3; border: 1px solid #666666; font-size:8pt; color: #000099" value="<?
