...
<table width="607" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <th width="237" height="30" class="small" scope="col"><strong>Reporte Facturas por fecha</strong></span></th>
    <th width="345" colspan="2" rowspan="2" scope="col"><table width="176" height="28" border="0" align="left" cellspacing="0" bgcolor="#FF9900">
      <tr>
...
$test11a = mysql_query("SELECT COUNT(*) from habitacion2 WHERE   fecha2 BETWEEN '$fecha1' and '$fecha2' ");
...
?>
      <?php						 
           ...
           if ( $id2  == 'calend1' and $test1[0] >= '1' )
			  { 
			 include("lista_facturas_x_cancelar3.php"); 
                 } 
			else 
           if ( $test1[0] == '0' )
			  { 
