...
<table width="619" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="220" height="28" bgcolor="#FFFFFF"><form action="opcion_prefactura.php" method="post">
  
      <div align="left">
        <table width="562" border="0" cellspacing="0">
        <tr>
          <th width="230" scope="col"><span class="small"> Prefactura de Clientes </span></th>
