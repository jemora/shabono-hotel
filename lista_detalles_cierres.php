...
$query_Recordset3 = "SELECT * FROM caja_gastos WHERE ref  LIKE '$id' ORDER BY id DESC ";
...
<tr><td><table width="601" border="0" align="center" cellspacing="2" bordercolor="#CCCCCC">
  <tr>
    ...
    <td width="100" height="8" bgcolor="#000000" ><span class="Estilo3">Fecha</span></td>
    <td height="8" bgcolor="#000000" ><span class="Estilo3">Tipo</span></td>
    <td height="8" bgcolor="#000000" ><span class="Estilo3">Descripci&ograve;n </span></td>
    <td height="8" bgcolor="#000000" ><span class="Estilo3">Monto</span></td>
    </tr>
  <?php do { ?>
  <tr>
    <td width="50" height="21" bgcolor="#E3E9F1" ><?php echo $row_Recordset3['id']; ?></td>
    <td width="100" bgcolor="#E3E9F1" ><?php echo $row_Recordset3['fecha']; ?></td>
    <td width="126" bgcolor="#E3E9F1" ><div align="left"><?php echo $row_Recordset3['tipo']; ?></div></td>
    <td width="100" bgcolor="#E3E9F1" ><div align="left"><?php echo $row_Recordset3['descripcion']; ?></div></td>
    <td bgcolor="#E3E9F1" ><div align="left"><?php echo $row_Recordset3['monto']; ?></div></td>
    </tr>
