...
$query_Recordset2 = "SELECT * FROM habitacion2  WHERE  fecha1 BETWEEN '$fecha1' and '$fecha2'";
...
<table width="601" border="0" align="center" cellspacing="2" bordercolor="#666666">
  <tr>
    <td height="8" colspan="6" bgcolor="#FFFFFF" ><span class="Estilo5 Estilo9">Clientes Alojadados Desde<?php echo $fecha1; ?> Hasta <?php echo $fecha2; ?> </span></td>
  </tr>
  <tr>
  ...
  <?php do { ?>
  <tr>
    <td width="92" height="30" bgcolor="#E3E9F1" ><span class="Estilo12"><?php echo $row_Recordset2['doc2']; ?></span></td>
    <td width="105" height="30" bgcolor="#E3E9F1" ><span class="Estilo12"><?php echo $row_Recordset2['nombre']; ?></span></td>
    <td width="107" bgcolor="#E3E9F1" ><span class="Estilo12"><?php echo $row_Recordset2['apellido']; ?></span></td>
    <td bgcolor="#E3E9F1" ><div align="left" class="Estilo12">Desde:<?php echo $row_Recordset2['fecha1']; ?>Hasta:<?php echo $row_Recordset2['fecha2']; ?></div></td>
    <td bgcolor="#E3E9F1" ><span class="Estilo12"><?php echo $row_Recordset2['nom_hab']; ?></span></td>
    <td bgcolor="#E3E9F1" ><span class="Estilo12"><?php echo $row_Recordset2['habitacion']; ?></span></td>
  </tr>
