...
$query_Recordset2 = "SELECT * FROM cierre_caja_mes ORDER BY id DESC";
...
<table width="613" border="0" align="center" cellspacing="0">
  <tr>
    <td width="549"><span class="Estilo2">Lista de Cajas cerradas por Mes :</span></td>
  </tr>
</table>
<table width="601" border="0" align="center" cellspacing="2" bordercolor="#CCCCCC">
  <tr>
    ...
    <td height="16" bgcolor="#000000" class="small" ><div align="center" class="Estilo4">Cierre de Mes</div></td>
  ...
  <?php do { ?>
  <tr>
    <td width="80" height="15" bgcolor="#E3E9F1" class="small" ><a href="lista_cierres_mes2.php?mes=<?php echo $row_Recordset2['mes']; ?>&ano=<?php echo $row_Recordset2['ano']; ?>">Ref</a></td>
    <td width="99" bgcolor="#E3E9F1" class="small" ><div align="center"><?php echo $row_Recordset2['mes']; ?> <?php echo $row_Recordset2['ano']; ?></div></td>
