...
<table width="601" border="0" align="center" cellspacing="2" bordercolor="#666666">
  <tr>
    <td height="8" colspan="5" bgcolor="#FFFFFF" ><div align="left"><span class="Estilo5 Estilo9">Acompa&ntilde;antes  Alojados </span></div></td>
  </tr>
  <tr>
    ...
    <td width="162" height="8" bgcolor="#7794AE" ><span class="Estilo11"><strong>Telefono</strong></span></td>
    <td width="134" height="8" colspan="2" bgcolor="#7794AE" ><span class="Estilo11"><strong>Correo </strong></span></td>
    </tr>
  <?php do { ?>
  <tr>
    ...
    <td bgcolor="#E3E9F1" ><div align="left"><span class="small"><?php echo $row_Recordset2['correo']; ?></span></div>      </td>
    <td bgcolor="#FFFFFF" ><font face="Arial" size="1"><a href="?id=borrar&codigo=<?php echo $codigo ?>&multi=<?php echo $multi; ?>&codigo2=<?php echo $row_Recordset2['id']; ?>"><img src="imagenes/ico_10.gif" alt="eliminar" width="16" height="12" border="0"></a><a href="borrar_empresas.php?&codigo=<?php echo $row_Recordset3['ID']; ?>"></a><a href="borrar_consumos.php?&amp;codigo2=<?php echo $row_Recordset2['ref']; ?>&amp;codigo3=<?php echo $row_Recordset2['id']; ?>&amp;codigo=<?php echo $row_Recordset2['cliente']; ?>"></a></font></td>
  </tr>
