...
if(document.frm.dato10.value == "") {
	...
	<br>
	<div id="resultado"><?php include('registro_demo.php');?></div>
	<?php
		//$dia = $_POST["dia"];
	?>
	...
	//////////////////////////////////////calculo de  un dia 
	$fecha_insertada=$fecha1;
	$sep="-"; // separación por si quieres poner fechas con 12-05-2004
	$ex=explode($sep, $fecha_insertada);
	if ($ex[1]!="12") 
	{
		$newdia=$ex[2]+1; $newMes=$ex[1]; $newAno="$ex[0]"; 
	}
	elseif ($ex[1]="12") 
	{ 
		$newMes="01"; $newAno=$ex[0]+1; 
	}
	$fecha11= "$newAno-$newMes-$newdia";
	///////////////////////consulta si  el dia esta  ocupado
	$test11a = mysql_query("SELECT * FROM habitacion2 WHERE habitacion like '$habitacion' and '$fecha11' BETWEEN '$fecha11' and fecha2 ");
	$test1 = mysql_fetch_row($test11a);
	...
	?>
		...
		<tr>
		  <td><div align="left">Anticipos</div></td>
		  <td><div align="left">
