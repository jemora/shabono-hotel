...
$query_Recordset3 = "SELECT * FROM caja WHERE opc  LIKE '1' ORDER BY id DESC ";
...
<tr>
  <td class="estilocelda">Cierres de Caja</td>
</tr>
<tr><td><table width="601" border="0" align="center" cellspacing="2" bordercolor="#CCCCCC">
  <tr>
    ...
    <td width="100" height="8" bgcolor="#000000" ><span class="Estilo3">Tipo</span></td>
    <td height="8" bgcolor="#000000" ><span class="Estilo3">Fecha de Apertura </span></td>
    <td width="50" height="8" bgcolor="#000000" ><div align="center"><span class="Estilo3">Monto de Apertura </span></div></td>
    <td width="50" height="8" bgcolor="#000000" ><div align="center"><span class="Estilo3">Monto de Cierre </span></div></td>
    <td height="8" bgcolor="#000000" ><div align="center" class="Estilo3">Usuario</div></td>
  </tr>
  <?php do { ?>
  <tr>
    <td width="50" height="21" bgcolor="#E3E9F1" ><span class="Estilo1"><a href="lista_detalles_cierres.php?&id=<?php echo $row_Recordset3['id']; ?>"><?php echo $row_Recordset3['id']; ?></a></span></td>
    ...
    <td width="50" bgcolor="#E3E9F1" ><div align="left"><?php echo $row_Recordset3['monto1']; ?></div></td>
