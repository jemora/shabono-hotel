...
$query_Recordset2 = "SELECT * FROM habitacion2 WHERE status LIKE 'ocupada' AND tipo LIKE '$tipo' AND opc LIKE '0'  AND  '$fecha1' BETWEEN fecha1 and fecha2 ORDER BY id ASC";
...
<DIV ID="seleccion">
  ...
  <tr>
    <td width="581" height="7" bgcolor="#FFFFFF" class="Estilo1 Estilo16" ><div align="left" class="Estilo9 Estilo21">Listado dede:<?php echo $fecha1; ?> Hasta: <?php  echo $fecha2; ?>
  ...
  <table width="601" border="2" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
    ...
    <tr>
      <td width="65" height="22" bgcolor="#000000" ><div align="left" class="Estilo1 Estilo3">
          <div align="center" class="Estilo27"><span class="Estilo16">N&ordm;  Factura</span></div>
      </div></td>
      <td width="94" height="22" bgcolor="#000000" ><div align="center" class="Estilo19"><span class="Estilo16">Habitaci&oacute;n</span></div></td>
      <td width="90" height="22" bgcolor="#000000" ><div align="left" class="Estilo19"><span class="Estilo16">Cliente</span></div></td>
 ...
 ?>
    <tr>
      <td width="65" height="32" rowspan="4" bgcolor="#E3E9F1" ><div align="center"><span class="Estilo19"><?php echo $row_Recordset2['id']; ?></span></div></td>
      <td width="94" rowspan="4" bgcolor="#E3E9F1" ><span class="Estilo19"><?php echo $row_Recordset2['nom_hab']; ?></span></td>
      <td width="90" rowspan="4" bgcolor="#E3E9F1" ><div align="left" class="Estilo19"><strong><?php echo $row_Recordset2['doc2']; ?></strong> <?php echo $row_Recordset2['nombre']; ?> <?php echo $row_Recordset2['apellido']; ?></div></td>
      <td rowspan="4" bgcolor="#E3E9F1" ><span class="Estilo20"><strong>Desde:</strong><?php echo $row_Recordset2['fecha1']; ?><br>
