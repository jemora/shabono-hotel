...
<div align="center"><img src="imagenes/banne5.gif" width="607" height="30" /></div>
<table width="619" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="220" height="28" bgcolor="#FFFFFF">
		<form action="opcion4.php" method="post">
  
      <div align="left">
        <table width="595" border="0" cellspacing="0">
        <tr>
          <th width="160" scope="col"><span class="small">Asignar Habitacion a Cliente </span></th>
          <th width="110" scope="col"><input name="codigo" type="text" id="codigo" size="22" maxlength="150" / style="background-color:e3e3e3; border: 1px solid #666666; font-size:8pt; color: #000099" /></th>
          <th width="62" scope="col"><input name="submit" type="submit" value="Buscar" /></th>
          <th width="149" scope="col"><span class="small">Clientes </span><span class="Estilo7"><a href="javascript:Abrir_ventana('buscador_cliente.php')"><img src="imagenes/view.gif" width="17" height="17" border="0" /></a></span></th>
          <th width="104" scope="col"><span class="small">Planning</span><span class="Estilo7"> <a href="javascript:Abrir_ventana('buscar_calendario.php')"><img src="imagenes/show-calendar.gif" width="18" height="16" border="0" /></a></span></th>
        </tr>
      </table>
        </div>
    </form>
