...
$query_Recordset2 = "SELECT * FROM servicio WHERE   id_serv LIKE '$codigo' ";
...
<table width="280" height="116" align="center" cellpadding="2" cellspacing="2" class="estilotabla">
  <tr>
    <td class="estilocelda">Actualizar Precio a Temporada</td>
  </tr>
  <tr>
    <td height="86"><form action="actualizar_precio_tarifas2.php?codigo=<?php echo $row_Recordset2['id_serv']; ?>&amp;codigo2=<?php echo $row_Recordset2['tipo']; ?>" method="post">
            <div align="left">
              <table width="471" border="0" cellspacing="0">
                <tr>
                  <th width="156" class="Estilo7" scope="col"><div align="left">Tipo de Tarifa</div></th>
                  <th width="310" scope="col"><div align="left"><?php echo $row_Recordset2['tipo']; ?></div>
                    </label></th>
                </tr>
                <tr>
                  <th class="Estilo7" scope="col"><div align="left">Precio de este tipo de Tarifa</div></th>
                  <th scope="col"><div align="left">
                    <input name="precio" type="text" id="precio" / style="background-color:e3e3e3; border: 1px solid #666666; font-size:8pt; color: #000099" value="<?php echo $row_Recordset2['precio']; ?>" size="25" />
                  </div></th>
                </tr>
                <tr>
                  <th class="Estilo7" scope="col"><div align="left">Observaciones</div></th>
                  <th scope="col"><div align="left">
                    <textarea name="obser" cols="40" id="obser" style="background-color:e3e3e3; border: 1px solid #666666; font-size:8pt; color: #000099"><?php echo $row_Recordset2['obser']; ?></textarea>
                  </div></th>
                </tr>
                <tr>
