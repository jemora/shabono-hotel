...
$query_Recordset2 = "SELECT * FROM habitacion2 WHERE status LIKE 'bloqueada' and '$fecha' BETWEEN fecha1 and fecha2 ORDER BY id ASC";
...
<table width="120" height="25" border="1" align="center" cellspacing="0" bordercolor="#99CCFF">
  ...
  <tr>
    ...
    <td width="17" bgcolor="#FFFFFF" ><a href="opcion_galeria2.php?&codigo2=<?php echo $row_Recordset2['id']; ?>&dato=<?php echo $row_Recordset2['id_hab']; ?>"><img src="imagenes/view.gif" alt="Detalles" width="17" height="17" border="0" longdesc="imagenes/view.gif"></a></td>
  </tr>
