...
<table width=601 height=140 align="center" cellpadding=2 cellspacing=2 class="estilotabla">
  <tr>
    <td width="165" height="16" class="estilocelda">Actualizar Logo Pagina WEB </td>
  </tr>
  <tr>
    ...
    <form ENCTYPE="multipart/form-data" action="informacion01.php?id5=logo2" method="POST">
	<p>
...
Where id='29'";
		...
		echo "<img src='ver_logo.php?id=29'>";
	}else{
