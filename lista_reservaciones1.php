...
$query_Recordset2 = "SELECT * FROM habitacion2 WHERE status LIKE 'reservada' ORDER BY id ASC";
...
<table width="605" border="0" align="center" cellspacing="2" bordercolor="#CCCCCC">
  ...
  <?php do { ?>
  <tr>
    <td height="50" bgcolor="#E3E9F1" ><div align="left" class="Estilo20"><strong><?php echo $row_Recordset2['doc2']; ?></strong> <?php echo $row_Recordset2['nombre']; ?> <?php echo $row_Recordset2['apellido']; ?></div>
        <div align="left" class="Estilo14"></div></td>
    <td width="135" height="50" bgcolor="#E3E9F1" ><span class="Estilo20"><?php echo $row_Recordset2['habitacion']; ?> <?php echo $row_Recordset2['nom_hab']; ?></span></td>
    ...
    <td width="9" c"><a href="javascript:Abrir_ventana1('acceso3.php?&amp;codigo=<?php echo $row_Recordset2['id']; ?>')"><img src="imagenes/edit.gif" width="17" height="17" border="0" /><br>
    </a><a href="acceso3.php?&amp;codigo=<?php echo $row_Recordset2['id']; ?>"><img src="imagenes/edit.gif" width="17" height="17" border="0" /></a></td>
