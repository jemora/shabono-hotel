...
<?
	...
	$result1 = mysql_query("SELECT * FROM hora WHERE cod  LIKE '0'  ");
...
<tr>
  <td class="estilocelda">Actualizar Hora Hotelera: </td>
</tr>
<tr><td><table width="597" height="15" border="0" align="center" cellspacing="0" bordercolor="#000000" bgcolor="#FF9900">
  <tr>
    <td width="591" height="28" bgcolor="#FFFFFF"><form action="actualizar_hora.php?&id=actualizar" method="post">
      <div align="left">
            ...
            <th scope="col"><table width="601" border="0" align="center" cellspacing="0" bgcolor="#F4F4F4">
              ...
              <tr>
                <td width="587" height="48" valign="top"><table width="601" border="0" align="center" cellspacing="0" bordercolor="#E3E9F1" class="Estilo1">
                          <!--DWLayoutTable-->
                          <tr>
                            <td width="151" bgcolor="#E3E9F1"><div align="left" ><strong>Hora</strong> Actual:</div></td>
                            <td bgcolor="#FFFFFF"><font face="Verdana">
                              <? while ($row=mysql_fetch_array($result1)){ echo "".$row["hora"].""; }?>
                            </font></td>
                          </tr>
                          <tr>
                            <td bgcolor="#E3E3E3"><strong>Actualizar hora Hotelera </strong></td>
                            <td bgcolor="#FFFFFF"><input name="hora" type="text" id="hora" size="22" maxlength="150" / style="background-color:e3e3e3; border: 1px solid #666666; font-size:8pt; color: #000099" />
