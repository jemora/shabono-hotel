...
<table width=601 height=140 align="center" cellpadding=2 cellspacing=2 class="estilotabla">
  <tr>
    <td width="165" class="estilocelda">Actualizar Imagen Membrete </td>
  </tr>
  <tr>
    ...
    <form ENCTYPE="multipart/form-data" action="informacion01.php?id5=membrete" method="POST">
	<p>
...
Where id='28'";
		...
		echo "<img src='ver_logo.php?id=28'>";
	}else{
