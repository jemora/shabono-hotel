...
<table width="81%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td width="100%" valign="top"><div align="right" >
		...
		<form name=frm onSubmit="return Verificar()" method="POST" action="guardar_cliente.php" enctype="multipart/form-data">
        ...
        <tr>
          <th width="591" scope="col"><table width="567" border="0" cellspacing="0" cellpadding="4" align="center">
            ...
            <tr>
              ...
              <td colspan="2"><select name="pais" style="background-color:e3e3e3; border: 1px solid #666666; font-size:8pt; color: #000099">
