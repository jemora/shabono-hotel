...
<body>
<table width="" border="0" align="center" cellspacing="2" bordercolor="#CCCCCC">
  <!--DWLayoutTable-->

  <tr>
    <td width="120" height="17" bgcolor="#FFFFFF" >&nbsp;</td>
    <td width="120" height="17" bgcolor="#FFFFFF" >&nbsp;</td>
    <td width="120" bgcolor="#FFFFFF" >&nbsp;</td>
    <td width="120" bgcolor="#FFFFFF" ><?php $dato_subtotal_apro= $row_Recordset22['subtotal_apro']; ?>
      <?php		
 ...
 $test11a2[0];
  ...
  <tr>
    <td colspan="3" rowspan="2" valign="top" bgcolor="#FFFFFF" ><div align="left">
      <?php $dato_observacion= $row_Recordset22['observaciones']; ?>
      <br>
        <?php		
    ...
    <td height="20" bgcolor="#FFFFFF" ><?php $dato_subtotal_iva_apro= $row_Recordset22['iva_apro']; ?>
      <?php		
...
$iva= $row_Recordset2_iva['iva']; 
 ...
 $iva2=$iva1/100;
  ...
  <tr>
    <td height="17" bgcolor="#FFFFFF" ><?php $dato_subtotal_nota_credito_apro= $row_Recordset22['nota_credito_apro']; ?>
      <?php		
...
<table width="" border="0" align="center" cellspacing="2" bordercolor="#CCCCCC">
  ...
  <tr>
    ...
    <td width="120" height="17" bgcolor="#FFFFFF" >&nbsp;</td>
    <td width="120" bgcolor="#FFFFFF" >&nbsp;</td>
    <td width="120" bgcolor="#FFFFFF" ><!--DWLayoutEmptyCell-->&nbsp;</td>
  </tr>
  <tr>
    <td height="17" colspan="4" valign="top" bgcolor="#FFFFFF" ><table width="<?php echo $row_Recordset2['ancho']; ?>" height="95" border="0" align="center" cellspacing="2" bordercolor="#CCCCCC">
      <tr>
  ...
  <tr>
    <td height="17" colspan="4" bgcolor="#FFFFFF" ><div align="left">
