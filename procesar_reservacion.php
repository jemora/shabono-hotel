    ...
    <td width="95" height="21" bgcolor="#FFFFFF" class="titulos"><div align="left" class="Estilo16">
      <div align="center"><?php
		$hab=$row_rsListadoCat['habitacion'];
			$hab_nombre=$row_rsListadoCat['observaciones'];
	require_once('conector/conector.php');
$link = mysql_connect($hostname, $username , $password); 
mysql_select_db($database ); 
$test11a = mysql_query("SELECT COUNT(*) from habitacion2 where tipo like '$hab' and '$fecha1' BETWEEN fecha1 and fecha2");
...
$nom_hab=$hab_nombre;
$usuario="online";
mysql_query("INSERT INTO habitacion2(doc2,habitacion,nota,subtotal1,obsev,tipo,status,personas,fecha,precio,cant_dia,fecha1,fecha2,opc2,multi,nombre,apellido,nom_hab,usuario) VALUES 
('$doc2','$habitacion','$nota','$subtotal1','$obsev','$tipo','$status','$personas','$fecha','$precio','$cant_dia','$fecha1',
'$fecha2','$opc2','$multi','$nombre','$apellido','$nom_hab','$usuario')");
mysql_close();
