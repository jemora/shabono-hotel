...
mysql_free_result($resultinfo)?></title><script language="JavaScript" type="text/javascript" src="date-picker.js"></script>
<!--
body,td,th {
        ...
        <td width="174" height="28" bgcolor="#FFFFFF"><form name="form1" action="?id2=tipo" method="post">
          <div align="left">
                <table width="550" border="0" cellspacing="0">
                  <tr>
                    <th colspan="5" scope="col"><div align="left" class="medium Estilo4"><strong>Habitaciones Ocupadas por Tipo</strong></div></th>
                    </tr>
                  <tr>
                    <th width="147" height="26" scope="col"><span class="small">Tipo de Habitacion</span><span class="Estilo3">:</span></th>
...
?>
                    ...
                    <th width="100" scope="col"><div align="right" class="small">Fecha Desde:</div></th>
                    <th width="164" scope="col"><div align="right">
