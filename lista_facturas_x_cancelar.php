...
<table width="601" border="1" align="center" cellspacing="0" bordercolor="#999999" bgcolor="#F4F4F4">
  <!--DWLayoutTable-->
  <tr>
    <td width="560" height="23" valign="top"><table width="601" border="0" align="center" cellpadding="0" cellspacing="0">
      <!--DWLayoutTable-->
      <tr>
        <td width="20" bgcolor="#F4F4F4"><span class="Estilo14"><a href="javascript:history.back(1)"><img src="imagenes/ico_3.gif" alt="Regresar" width="18" height="18" border="0" /></a></span></td>
        <td width="148" bgcolor="#F4F4F4"><span class="Estilo14" >Regresar</span></td>
        <td width="230" bgcolor="#F4F4F4"><!--DWLayoutEmptyCell-->&nbsp;</td>
        <td width="195" bgcolor="#F4F4F4"><div align="right"><span class="small"><a href="javascript:Abrir_ventana('generar_reporte1.php')">Imprimir Reporte</a> </span><img src="imagenes/print.gif" width="16" height="11"></div></td>
      </tr>
    </table></td>
  </tr>
</table>
