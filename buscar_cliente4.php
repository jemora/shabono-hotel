...
<div align="center"><img src="imagenes/banne7.gif" width="607" height="30" />
  <br />
  <?php include("logo.php");?></div>
<table width="0" border="0" align="center">
  <tr>
    <th scope="col">
	<form action="opcion5.php" method="POST">
  
      <div align="left">
        <table width="583" border="0" cellspacing="0">
        <tr>
          <th width="207" scope="col"><span class="small">Asignar Consumo a Cliente </span></th>
          ...
          <th width="55" scope="col"><input name="submit" type="submit" value="Buscar" /></th>
          <th width="129" scope="col"><span class="small">Clientes</span><span class="Estilo7"> <a href="javascript:Abrir_ventana('buscador_cliente.php')"><img src="imagenes/view.gif" width="17" height="17" border="0" /></a></span></th>
          <th width="92" class="small" scope="col">Planning <a href="javascript:Abrir_ventana('buscar_calendario.php')"><img src="imagenes/show-calendar.gif" width="18" height="16" border="0" /></a></th>
        </tr>
      </table>
        </div>
    </form></th>
