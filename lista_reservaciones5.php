...
$query_Recordset2 = "SELECT * FROM habitacion2  WHERE  status LIKE 'reservada' and fecha1 BETWEEN '$fecha1' and '$fecha2' ";
...
<table width="605" border="0" align="center" cellspacing="2" bordercolor="#CCCCCC">
  ...
  <?php do { ?>
  <tr>
    <td height="28" bgcolor="#E3E9F1" ><div align="left" class="Estilo19"><?php echo $row_Recordset2['doc2']; ?> <?php echo $row_Recordset2['nombre']; ?> <?php echo $row_Recordset2['apellido']; ?></div>
        <div align="left" class="Estilo19"></div></td>
    <td width="135" height="28" bgcolor="#E3E9F1" ><span class="Estilo19"><?php echo $row_Recordset2['habitacion']; ?><?php echo $row_Recordset2['nom_hab']; ?></span></td>
