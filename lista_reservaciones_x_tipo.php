...
$query_Recordset2 = "SELECT * FROM habitacion2 WHERE status LIKE 'reservada' and tipo LIKE '$tipo'  AND  '$fecha1' BETWEEN fecha1 and '$fecha2' ORDER BY id ASC";
...
<DIV ID="seleccion">
  ...
  <tr>
    <td height="7" colspan="6" bgcolor="#FFFFFF" class="Estilo1 Estilo16" ><div align="left" class="Estilo9 Estilo21">Listado dede:<?php echo $fecha1; ?> Hasta: <?php  echo $fecha2; ?>
  ...
  <tr>
    ...
    <td height="7" colspan="4" bgcolor="#000000" class="Estilo1" ><span class="Estilo18">Fecha</span></td>
  </tr>
  <?php do { ?>
    <tr>
      <td height="28" bgcolor="#E3E9F1" ><div align="left" class="Estilo14 Estilo19"><strong><?php echo $row_Recordset2['doc2']; ?></strong> <?php echo $row_Recordset2['nombre']; ?> <?php echo $row_Recordset2['apellido']; ?></div>
          <div align="left" class="Estilo20"></div></td>
