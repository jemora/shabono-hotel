...
<table width="601" border="0" align="center">
  <tr>
    <th colspan="4" scope="col"><form action="opcion8.php" method="post">
      <div align="left">
        <table width="592" border="0" cellspacing="0">
          <tr>
            <th width="185" scope="col"><span class="small"> Facturas de Clientes </span></th>
            <th width="105" scope="col"><input name="codigo2" type="text" id="codigo2" size="22" maxlength="150" / style="background-color:e3e3e3; border: 1px solid #666666; font-size:8pt; color: #000099" /></th>
            <th width="123" scope="col"><input name="submit" type="submit" value="Buscar" /></th>
            <th width="86" class="small" scope="col">Clientes <a href="javascript:Abrir_ventana('buscador_cliente.php')"><img src="imagenes/view.gif" width="17" height="17" border="0" /></a></th>
            <th width="83" scope="col"><span class="small">Planning <a href="javascript:Abrir_ventana('buscar_calendario.php')"><img src="imagenes/show-calendar.gif" width="18" height="16" border="0" /></a></span></th>
          </tr>
        </table>
      </div>
    </form></th>
  ...
  <tr>
    <th colspan="4" bgcolor="#FFFFFF" scope="col"><div align="left" class="Estilo10">
  ...
  <tr>
    <th colspan="4" bgcolor="#000000" scope="col"><div align="left"><span class="Estilo10">Cambio de Habitaci&ograve;n </span></div></th>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <th bgcolor="#E3E9F1" scope="col"><div align="left"><span class="Estilo9"><?php echo $row_Recordset2['fecha2']; ?></span></div></th>
  </tr>
</table>
<br>
<br>
<table width="351" border="1" align="center" cellspacing="0" bordercolor="#000000">
  <tr>
    <td width="349">
	
	  <form name=frm onSubmit="return Verificar()" method="post" action="pagina34.php" enctype="multipart/form-data">
	    <table width="601" border="0" align="center">
	      <?php
...
?>
  ...
  <tr>
    <td>
      <div align="center">
        <input name="button" type="submit" value="   Cambiar Habitacion   ">
          </div></td>
    <td>&nbsp;</td>
  </tr>
        </table>
