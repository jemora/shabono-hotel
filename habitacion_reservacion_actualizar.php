...
$query_Recordset223 = "SELECT * FROM habitacion2 WHERE id like '$codigo'";
...
<div id="resultado"><?php include('registro_demo3.php');?></div>
<form name=calform onSubmit="return Verificar()"  method="post" action="?&amp;codigo=<?php echo $row_Recordset223['id']; ?>" enctype="multipart/form-data">
...
<span class="Estilo15"><?php echo $row_Recordset223['id']; ?></span>
<form name="form1" onSubmit="enviarDatosEmpleado1(); return false" method="post" action="habitacion_reservacion_actualizar.php?codigo=<?php echo $row_Recordset223['id']; ?>" enctype="multipart/form-data" >
<br />
...
?>
    ...
    <tr>
      ...
      <td><div align="left">
        <input name="nota" type="text" id="nota" value="<?  echo  $codigo; ?>" />
      </div></td>
    </tr>
    <tr>
...
?>" />
        ...
        <input name="codigo" type="hidden" id="codigo" value="<?php echo $row_Recordset223['id']; ?>" /><?php echo  $_POST['codigo']; ?>
