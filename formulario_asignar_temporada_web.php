...
$result_precio = mysql_query("SELECT * FROM servicio   WHERE tipo  LIKE '$tipo_tarifa'");
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO hab_tipo_web (nombre_tipo, tipo,  precio, tipo_tarifa) VALUES ( %s,%s, %s, %s)",           GetSQLValueString($_POST['nombre_tipo'], "text"),
                       GetSQLValueString($tipo, "text"),
                        GetSQLValueString($precio, "text"),
                       GetSQLValueString($_POST['tipo_tarifa'], "text"));
      ...
      <table align="center">
            <tr valign="baseline">
              ...
              <td><font 
                                ...
                                face="Arial,a Helvetica, sans-serif" size="1"><span class="titulos">
                <select name="nombre_tipo" id="nombre_tipo" style="background-color:e3e3e3; border: 1px solid #666666; font-size:8pt; color: #000099" >
                  <?php mysql_select_db($database, $connFlashblog);
$query_rsCategorias = "SELECT * FROM  hab_tipo ";
...
?>
            ...
            <tr valign="baseline">
              ...
              <td><font 
                ...
                <select name="tipo_tarifa" id="tipo_tarifa" style="background-color:e3e3e3; border: 1px solid #666666; font-size:8pt; color: #000099" >
                  <?php mysql_select_db($database, $connFlashblog);
...
?>
            ...
            <tr valign="baseline">
              <td nowrap align="right"><font face="Verdana" size="2"><font face="Verdana" size="2"><font face="Verdana" size="2"><font face="Verdana" size="2"><font face="Verdana" size="2"><span class="Estilo3">
                ...
                </span></font></font></font></font><span class="Estilo3">
...
<br>
<?php include('lista_habitaciones_asignacion_tarifas_web.php'); ?>
