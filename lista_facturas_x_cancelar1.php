...
$query_Recordset2 = "SELECT * FROM habitacion2 WHERE opc like '0' and opc2 like '1'  and  status LIKE 'ocupada' and doc2 like '$codigo' ORDER BY fecha DESC";
...
<table width="601" border="1" align="center" cellspacing="0" bordercolor="#999999" bgcolor="#F4F4F4">
  ...
  <tr>
    <td width="560" height="24" valign="top"><table width="601" border="0" align="center" cellspacing="0">
      <!--DWLayoutTable-->
      <tr>
        <td width="19" bgcolor="#F4F4F4"><span class="Estilo17"><a href="javascript:history.back(1)"><img src="imagenes/ico_3.gif" alt="Regresar" width="18" height="18" border="0" /></a></span></td>
        <td width="136" bgcolor="#F4F4F4"><span class="Estilo17 Estilo20" >Regresar</span></td>
...
<table width="601" border="2" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
 ...
 ?>
  <tr>
    ...
    <td rowspan="4" bgcolor="#E3E9F1" ><span class="Estilo17 Estilo20"><strong>Desde:</strong><?php echo $row_Recordset2['fecha1']; ?><br>
